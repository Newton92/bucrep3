...
class Command(BaseCommand):
        ...
        try:
            if dry_run:
                ...
                with transaction.atomic():
                    ...
                    self.stdout.write("[SUCCESS] " + 'Successfully imported NACE data!')
    ...
    def import_data(self, entries, poids_categories):
            ...
            if activity_code not in category_map:
                ...
                if created:
                    ...
                    self.stdout.write(self.style.SUCCESS(
                        f'[OK] Created category: {activity_code} - {activity_name} (poids: {poids})'
                    ))
                else:
                    self.stdout.write(self.style.WARNING(
                        f'[UPD] Updated category: {activity_code} - {activity_name} (poids: {poids})'
                    ))
        ...
        # Résumé final
        self.stdout.write("\n" + "="*50)
        self.stdout.write("[SUCCESS] " + f'Import completed!')
