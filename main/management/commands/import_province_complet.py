...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS(_("Début de l'import complet des provinces...")))
        ...
        if not options['skip_provinces']:
            ...
            try:
                ...
                self.stdout.write(self.style.SUCCESS(_("✓ Import provinces terminé")))
        ...
        if not options['skip_villes']:
            ...
            try:
                ...
                self.stdout.write(self.style.SUCCESS(_("✓ Association villes terminée")))
            except Exception as e:
