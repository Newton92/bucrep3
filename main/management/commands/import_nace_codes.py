...
class Command(BaseCommand):
    ...
    def get_or_create_category(self, code, name, dry_run):
        ...
        if created:
            self.stdout.write(self.style.SUCCESS(f'✓ Created category: {code} - {name}'))
        else:
            self.stdout.write(self.style.WARNING(f'↻ Updated category: {code} - {name}'))
    ...
    def get_or_create_subcategory(self, category, code, denomination, type_code, dry_run):
        ...
        if created:
            self.stdout.write(self.style.SUCCESS(f'  ✓ Created subcategory: {code} - {denomination}'))
        else:
            self.stdout.write(self.style.WARNING(f'  ↻ Updated subcategory: {code} - {denomination}'))
