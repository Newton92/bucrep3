...
def dash_root(request):
    ...
    try:
        # Le décorateur @login_required assure que `request.user` est bien authentifié
        # et que la session est valide. Il n'est pas nécessaire de vérifier le token.
        user = request.user
        
        # Génération des tokens d'accès (optionnel ici si vous n'avez besoin que de la session)
        # L'authentification par session et par token sont des méthodes distinctes.
        # Vous n'en avez probablement pas besoin sur une vue frontend classique.
        # refresh = RefreshToken.for_user(user)
...
def dash_root_code_nace(request):
    ...
    try:
        ...
        # Récupérer toutes les catégories NACE
...
def dash_root_code_naf(request):
    ...
    try:
        ...
        # Récupérer toutes les catégories NAF
...
def dash_root_modele_relation_entreprise(request):
    ...
    try:
        ...
        return render(
            request,
            "main/root/modele/dash_root_modele_relation_entreprise.html",
            context
        )
...
def dash_root_modele_comportement_paiement(request):
    ...
    try:
        ...
        return render(
            request,
            "main/root/modele/dash_root_modele_comportement_paiement.html",
            context
        )
...
def dash_root_modele_comportement_jugement(request):
    ...
    try:
        ...
        return render(
            request,
            "main/root/modele/dash_root_modele_comportement_jugement.html",
            context
        )
...
def dash_root_category_entreprise(request):
    ...
    try:
        ...
        return render(
            request,
            "main/root/entreprise/dash_root_category_entreprise.html",
            context
        )
...
def dash_root_structure_entreprise(request):
    ...
    try:
        ...
        return render(
            request,
            "main/root/structure/dash_root_structure_entreprise.html",
            context
        )
...
def dash_root_statut_entreprise(request):
    ...
    try:
        ...
        return render(
            request,
            "main/root/statut/dash_root_statut_entreprise.html",
            context
        )
...
def dash_root_manage_acheteur(request, acheteur_id):
    ...
    try:
        ...
        return render(
            request,
            "main/root/acheteur/dash_root_manage_acheteur.html",
            context
        )
...
def dash_root_manage_acheteur_resume(request, acheteur_id):
    ...
    try:
        ...
        coloration_list = CouleurCommentaire.objects.all()
        bons_postes_list = BON_POST_CHOICES_CHOICES  # depuis constantes.py
...
def dash_root_manage_acheteur_tendance(request, acheteur_id):
    ...
    try:
        ...
        # Récupérer la liste des avis commerciaux
...
def dash_root_manage_acheteur_membre_conseil(request, acheteur_id):
    ...
    try:
        ...
        # Récupérer les postes et colorations
        poste_list = PosteEntreprise.objects.all()
        coloration_list = CouleurCommentaire.objects.all()
...
def dash_root_manage_acheteur_composition_capital(request, acheteur_id):
    ...
    try:
        ...
        # Récupérer les devises et colorations
        devise_list = Devise.objects.all()
        coloration_list = CouleurCommentaire.objects.all()
...
def dash_root_manage_acheteur_filiale(request, acheteur_id):
    ...
    try:
        ...
        # Récupérer toutes les structures d'entreprise
...
def dash_root_manage_acheteur_compte_financier(request, acheteur_id):
    ...
    try:
        ...
        # Récupérer tous les modèles de bilan
...
def dash_root_manage_acheteur_resultat_irfs(request, acheteur_id):
    ...
    try:
        ...
        return render(
            request,
            "main/root/acheteur/bilans/irfs/dash_root_manage_acheteur_resultat_irfs.html",
            context,
        )
...
def dash_root_manage_acheteur_add_passif_irfs(request, acheteur_id):
    ...
    try:
        ...
        # Récupérer tous les comptes financiers irfs de type Passif
        compte_financier_irfs_list = CompteFinancierIrfs.objects.filter(
            type_compte__icontains="Passif"
        )

        # Récupérer tous les actifs financiers irfs de type Passif pour cet acheteur
        actif_financier_irfs_list = ValeurCompteIrfs.objects.filter(
            compte__type_compte__icontains="Passif", acheteur__pk=id_acheteur
        )

        # Récupérer tous les années
        annee_list = Annee.objects.all()
...
def dash_root_commande(request):
    ...
    try:
        ...
        # Récupérer tous les devises (liste one)
        devise_list_one = Devise.objects.all()

        # Récupérer tous les devises (liste two)
...
def dash_root_add_alerte(request):
    ...
    try:
        ...
        # Générer une référence aléatoire pour l'alerte
        import random
...
def dash_root_edit_new_alerte(request, reference):
    ...
    try:
        ...
        # Récupérer tous les documents liés à cette alerte
...
def dash_root_edit_alerte(request, alerte_id):
    ...
    try:
        ...
        # Récupérer tous les documents liés à l'alerte
...
def dash_root_add_portefeuille(request, portefeuille_id=None):
    ...
    try:
        ...
        if portefeuille_id:
            ...
            selected_elements = portefeuille.elements_surveillance_actifs.values_list("id", flat=True)
...
def dash_root_edit_portefeuille(request, portefeuille_id):
    ...
    try:
        ...
        context = {
            ...
            "acheteurs_associes": list(acheteurs_associes),
...
def dash_root_element_surveillance(request):
    ...
    try:
        ...
        # (Note : La logique pour `elements` n'est pas définie dans le code fourni.
        # Si elle est nécessaire, assurez-vous de la définir avant cette boucle.)
        # Exemple de boucle si `elements` est défini :
        # for element in elements:
        #     ElementSurveillance.objects.get_or_create(
        #         code_interne=element["code_interne"],
        #         defaults={
        #             "nom": element["nom"],
...
def dash_root_manage_acheteur_bilan_actif_bancaire_0(request, acheteur_id):
    ...
    try:
        ...
        # Gérer le cas où l'acheteur n'existe pas
        return render(request, "main/index.html", {"error": _("Acheteur introuvable.")})
...
def dash_root_manage_acheteur_bilan_actif_bancaire(request, acheteur_id):
    ...
    try:
        ...
        context = {
            ...
            "hors_bilans_page": hors_bilans_page_obj,
        }
