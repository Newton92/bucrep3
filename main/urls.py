...
urlpatterns = [
    ...
    path("support-technique/documentation/bucrep-version-3/", support_doc_bucrep, name="support_doc_bucrep"),
    path("support-technique/documentation/demande-de-rapport-de-solvabilite/", support_doc_demand_report, name="support_doc_demand_report"),
    path("support-technique/documentation/licence-autonome/", support_doc_licence_autonome, name="support_doc_licence_autonome"),
    path("support-technique/documentation/licence-autonome/details-techniques/", support_doc_licence_autonome_details, name="support_doc_licence_autonome_details"),
    
    path("notre-blog/", blog, name="blog"),
    path("notre-blog/article/", blog_article, name="blog_article"),
    path("webinaires/", webinaires, name="webinaires"),
    path("webinaires/masterclass/", webinaires_masterclass, name="webinaires_masterclass"),
    
    path("espace-prive/se-connecter/", connexion, name="connexion"),
    path("espace-prive/inscription/", registration, name="registration"),
    path("espace-prive/mot-de-passe-oublie/", forgot_password, name="forgot_password"),
    path("espace-prive/recuperation-mot-de-passe/", reset_password, name="reset_password"),
    
    path("nos-services/", solutions, name="solutions"),
    path("nos-services/rapport-de-solvabilite/", solvency_report, name="solvency_report"),
    path("nos-services/rapport-de-solvabilite/modele/", solvency_report_model, name="solvency_report_model"),
    path("nos-services/abonnement-saas/", abonnement_saas, name="abonnement_saas"),
    path("nos-services/licence-autonome/", licence_autonome, name="licence_autonome"),
    path("nos-services/acces-api-bucrep-3.0/", access_api_bucrep, name="access_api_bucrep"),
    
    path("nos-services/commander-un-rapport/", orders_report, name="orders_report"),
    path("nos-services/demander-une-demo/", ask_demo, name="ask_demo"),
    path("nos-services/demande-essai-gratuit/", free_trial, name="free_trial"),
    path("nos-services/documentation-api/", documentation_api, name="documentation_api"),
    path("nos-services/cles-api/", key_api, name="key_api"),
    path("nos-services/cles-api/plan-gratuit/", key_api_free, name="key_api_free"),
    path("nos-services/cles-api/demande-de-devis", key_api_devis, name="key_api_devis"),
    path("nos-services/contacter-equipe-commerciale/", contact_commercial_team, name="contact_commercial_team"),
    path("nos-services/discuter-avec-un-expert/", discuss_with_expert, name="discuss_with_expert"),
    ...
    path(
        "root-dashboard/acheteurs/manager-un-acheteur/<int:acheteur_id>/bilan-syscohada/ratios/",
        dash_root_manage_acheteur_ratio_syscohada,
        name="dash_root_manage_acheteur_ratio_syscohada",
    ),
    path(
    ...
    path(
        "root-dashboard/acheteurs/manager-un-acheteur/<int:acheteur_id>/bilan-ifrs/ratios/",
        dash_root_manage_acheteur_ratio_ifrs,
        name="dash_root_manage_acheteur_ratio_ifrs",
    ),
    path(
    ...
    path(
        "api/orders/module/<int:commande_id>/generer-rapport/",
        GenererRapportCommandeAPIView.as_view(),
        name="generer-rapport-commande",
    ),
    path(
